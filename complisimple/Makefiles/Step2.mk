...
# Debug 1: Launch the server
		...
		$(call TRACE,"11-DEBUG",$(UPLOADER))
		-killall openocd
		@osascript -e 'tell application "Terminal" to do script "openocd --file \"$(UTILITIES_PATH_SPACE)/ek_lm4f120xl.cfg\""'
...
# Debug 1: Launch the server
		...
		$(call TRACE,"11-DEBUG",$(UPLOADER))
		-killall openocd
		@osascript -e 'tell application "Terminal" to do script "openocd --file \"$(UTILITIES_PATH_SPACE)/cc3200.cfg\""'
...
ifeq ($(BOARD_PORT),pgm)
  ...
  ifeq ($(AVRDUDE_SPECIAL),1)
		$(call SHOW,"10.4-UPLOAD",$(UPLOADER) $(AVRDUDE_PROGRAMMER))
